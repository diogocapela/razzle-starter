...
function TermsAndConditions({ t }) {
  return (
    <Container className={styles.wrapper}>
      <PageTitle title={t('terms-and-conditions')} />
      <p>By downloading or using the app, these terms will
        ...
        [Developer/Company name].</p>
      <p>[Developer/Company name] is committed to ensuring that the app
      ...
      <p>The [App Name] app stores and processes personal data
     that you have provided to us, in order to provide
     [my/our] Service. It’s your responsibility to keep your
     ...
     security features and it could mean that the
        [App Name] app won’t work properly or at all.</p>
     ...
     [Developer/Company name] cannot take responsibility for the
     ...
     access to Wi-Fi, and you don’t have any of your data
      ...
      <p>If you’re using the app outside of an area with Wi-Fi, you
       ...
       that you have received permission from the bill payer for
        using the app.</p>
      <p>Along the same lines, [Developer/Company name] cannot always
     ...
     Service, [Developer/Company name] cannot accept
        responsibility.</p>
      <p>With respect to [Developer/Company name]’s responsibility for
     ...
     [Developer/Company name] accepts no liability for any loss,
     ...
     using the app. [Developer/Company name] does not promise that
     ...
     will end; (b) you must stop using the app, and (if needed)
      ...
      <p><strong>Changes to This Terms and Conditions</strong></p> <p>[I/We] may update our Terms and Conditions
     ...
     Conditions on this page. These changes are effective
      ...
      <p><strong>Contact Us</strong></p> <p>If you have any questions or suggestions about
     [my/our] Terms and Conditions, do not hesitate to
        contact [me/us] at [App Contact informations].</p>
    </Container>
  );
}
